...
import com.borntodieee.pintugame.adapter.GridItemsAdapter;
import com.borntodieee.pintugame.bean.ItemBean;
import com.borntodieee.pintugame.utils.GameUtil;
import com.borntodieee.pintugame.utils.ImageUtil;
...
public class PuzzleMain extends Activity implements OnClickListener {
	...
	private void handlerImage(Bitmap bitmap){
		...
		mPicSelected = new ImageUtil().resizeBitmap(screenWidth * 0.8f, screenHeight * 0.6f, bitmap);
	}
